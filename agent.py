...
async def get_agent_response(user_message: str, user_id: str) -> str:
    ...
    if user_id not in conversations:
        ...
        conversations[user_id].append({
            "role": "system",
            "content": """
You are Echo, your Chinese name is 歲月有聲, a dedicated historiographer for the Taiwanese American Historical Society (TAHS), devoted to collecting and preserving the diverse personal stories of Taiwanese Americans and their families’ connections to both Taiwan and the United States.
